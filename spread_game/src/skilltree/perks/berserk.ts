			...
			triggers: [
				{
					...
					getValue: (
						...
						TimedProps<
							BubbleFightProps | VisualizeBubbleProps | VisualizeCellProps
						>
					>[] => {
						...
						const visualCellProps: AttachProps<TimedProps<VisualizeCellProps>> =
							{
								...bubbleProps,
								triggerType: "SendUnits" + game.timePassed.toString(),
								entity: {
									type: "Cell",
						...
						return [bubbleProps, visualBubbleProps, visualCellProps];
					},
				},
			],
		};
